...
// (opcional) resumenes por paciente
Route::get(
    '/pacientes/{paciente}/resumenes',
    [ResumenesCitasController::class, 'porPaciente']
...
// 👉 NUEVO: calendario y listado por día (DEBEN IR ANTES de /citas/{cita})
Route::get('/citas/calendario', [CitasPacientesController::class, 'calendario'])
    ->name('citas.calendario');

Route::get('/citas/dia', [CitasPacientesController::class, 'porDia'])
    ->name('citas.porDia');

// (opcional) si quieres seguir usando el método todas()
Route::get('/citas/todas', [CitasPacientesController::class, 'todas'])
    ->name('citas.todas');
...
// 👉 Rutas por ID AL FINAL y restringidas a números
