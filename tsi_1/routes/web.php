...
// usar paciente existente (cuadro verde)
Route::post('/citas/usar-paciente', [CitasPacientesController::class, 'usarPaciente'])->name('citas.usarPaciente');
...
// Calendario y listado por día (SECRETARÍA)
...
// ----- Reservar cita (público, template.master) -----
...
// ----- Reservar cita DESDE SECRETARÍA (template.secretaria) -----
Route::get('/secretaria/citas/reservar',  [CitasPacientesController::class, 'createSecretaria'])
    ->name('secretaria.citas.create');
Route::post('/secretaria/citas/reservar', [CitasPacientesController::class, 'store'])
...
// Edición de citas desde la zona de SECRETARIA
Route::get('/citas/{cita}/edit-secretaria', [CitasPacientesController::class, 'editSecretaria'])
    ->name('citas.editSecretaria');

Route::put('/citas/{cita}/update-secretaria', [CitasPacientesController::class, 'updateSecretaria'])
    ->name('citas.updateSecretaria');
...
// INDEX para secretaría (lista todos los resúmenes)
Route::get('/resumen-citas', [ResumenesCitasController::class, 'index'])
    ->name('resumenCitas.index');
