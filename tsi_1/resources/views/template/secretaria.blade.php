  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav mx-auto gap-3">
        <li class="nav-item">
          <a class="nav-link text-white" href="{{ route('pacientes.index') }}">Gestión de Pacientes</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="{{ route('medicos.index') }}">Gestión de Médicos</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="{{ route('citas.calendario') }}">Ver todas las citas</a>
        </li>
      </ul>
    </div>
  </div>
